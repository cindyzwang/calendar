...
describe('FullCalendar', () => {
  it('renders month mode correctly', () => {
    const wrapper = render(<FullCalendar type="month" Select={Select} />);
    expect(wrapper).toMatchSnapshot();
  });

  it('renders date mode correctly', () => {
    const wrapper = render(<FullCalendar type="date" Select={Select} />);
    expect(wrapper).toMatchSnapshot();
  });

  it('renders fullscreen correctly', () => {
    const wrapper = render(<FullCalendar fullscreen Select={Select} />);
    expect(wrapper).toMatchSnapshot();
  });

  it('renders custom header correctly', () => {
    const wrapper = render(
      <FullCalendar Select={Select} headerRender={() => <div key="header">custom header</div>} />,
    );
    expect(wrapper).toMatchSnapshot();
  });
  ...
  describe('type', () => {
    it('renders defaultType correctly', () => {
      const wrapper = render(<FullCalendar defaultType="date" Select={Select} />);
      expect(wrapper).toMatchSnapshot();
    });

    it('controlled type', () => {
      const wrapper = mount(<FullCalendar type="date" Select={Select} />);
  ...
  it('select month', () => {
    ...
    const wrapper = mount(<FullCalendar type="month" Select={Select} />);
